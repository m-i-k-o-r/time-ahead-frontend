...
class AddActivityScreen extends StatefulWidget {
  ...
  const AddActivityScreen({super.key, required this.onAdd, required List<String> Function() getCategories});
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      widget.onAdd(
                        ...
                        _categoryController.text.isEmpty ? 'No Category' : _categoryController.text,
